   ...
   return (
      <section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
         ...
         <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6  relative z-[1]">
            <h1 className={`${styles.heading2} xs:text-center sm:text-start sm:text-[48px]`}>
         ...
         <div className="flex flex-wrap sm:justify-start justify-center w-full feebback-container relative z-[1]">
            {feedback.map((card) => (
